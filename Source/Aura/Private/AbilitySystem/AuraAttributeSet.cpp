...
void UAuraAttributeSet::ShowFloatingText(const FEffectProperties& Props, float Damage, bool bBlockedHt, bool bCriticalHit) const
{
	if (Props.SourceAvatarActor != Props.TargetCharacter)
	{
